...
export default function LoginForm() {
  ...
  <div className="max-w-md w-full space-y-8 p-8 bg-gray-900 bg-opacity-90 rounded-lg shadow-lg">
    <div>
    ...
    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
      <div className="relative">
        ...
        <input type="email" id="email" name="email" className="w-full rounded-md border-gray-300 shadow-sm p-2 mt-1 text-white bg-gray-900 focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500" value={email} onChange={(e) => setEmail(e.target.value)} />
      </div>
      <div className="relative">
        <label htmlFor="password" className="text-white font-bold">Password:</label>
        <input type="password" id="password" name="password" className="w-full rounded-md border-gray-300 shadow-sm p-2 mt-1 text-white bg-gray-900 focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500" value={password} onChange={(e) => setPassword(e.target.value)} />
      </div>
    ...
    <div className="mt-4">
      <button className="w-full bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" onClick={handleGoogleSign}>
        Sign in with Google
      </button>
    </div>
  </div>
